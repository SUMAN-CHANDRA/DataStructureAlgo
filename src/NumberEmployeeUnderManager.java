...
//		{
//			if(freq.get(dataSet.get(k))!=null)
//			{
//				freq.get(dataSet.get(k)).add(k);
//				freq.put(dataSet.get(k),freq.get(dataSet.get(k)));
//			}
//			else
//			{
//				List<String> newList= new ArrayList<String>();
//				newList.add(k);
//				freq.put(dataSet.get(k),newList);
//			}
//		}
//		System.out.println(freq);
//		for(String k:freq.keySet())
//		{
//			for(int i=0;i<freq.get(k).size();i++)
//			{
//				if(freq.get(freq.get(k).get(i))!=null)
//				{
//					freq.get(k).addAll(freq.get(freq.get(k).get(i)));
//				}
//			}
//		}
//		System.out.println(freq);
